...
// total rows
$totalRes = mysqli_query($conn,"SELECT COUNT(*) as total FROM sales $where");
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        function loadData(page = 1) {
                                            ...
                                            fetch(
                                                    `assets/scripts/fetch_saleslog.php?search=${encodeURIComponent(search)}&page=${page}&limit=${limit}`
                                                )
                                                .then(res => res.text())
                                                .then(data => {
