                            ...
                            <div class="col-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <div style="display:flex; gap:10px; align-items:center;">
                                            ...
                                            <input type="text" id="search" class="form-control"
                                                placeholder="Search user..." style="flex:1;">
                                            ...
                                            <a href="add_user.php" title="Add" class="btn btn-primary btn-animation">
                                    ...
                                    function loadData(page = 1) {
                                        ...
                                        fetch(
                                                `assets/scripts/fetch_users.php?search=${encodeURIComponent(search)}&page=${page}&limit=${limit}`
                                            )
                                            .then(res => res.text())
                                            .then(data => {
